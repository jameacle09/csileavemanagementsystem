    ...
    componentDidMount() {
        ...
        fetch("http://localhost/api/staffprofile/1")
            ...
            .catch(err => {
                ...
                let userData = {
                    csiStaffId: "1234567890",
                    staffName: "Junnel Soriao Teves",
                    email: "netkiko@gmail.com",
                    icNumber: "9191919922",
                    jobTitle: "SSE",
                    mobileNo: "0111010101010",
                    businessUnit: "CFIT",
                    managerName: "Russel Faulkner",
                    joinDate: "12/12/2019",
                    lineManager: "Russel Faulkner"
                };
            ...
            <div>
                    ...
                    <div className="nameContainerFlex">
                        ...
                        <div className="mainListContainer">
                            <ul className="mainList">
                                ...
                                <li>
                                    Job Title{" "}
                                    <p className="mainDataText">{userData["jobTitle"]}</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="containerFlex">
                    ...
                    <ListGroup className="ListGroupStyleFlex">
                        ...
                        <ListGroupItem>
                            Join Date: <p className="dataText">{userData["joinDate"]}</p>
                        </ListGroupItem>
                    </ListGroup>
                    <ListGroup className="ListGroupStyleFlex">
                        ...
                        <ListGroupItem>
                            Mobile No.: <p className="dataText">{userData["mobileNo"]}</p>
                        </ListGroupItem>
                    </ListGroup>
                </div>
                <br />
